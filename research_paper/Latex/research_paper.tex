...
\graphicspath{{./fig/}}
\usepackage{multirow, indentfirst, cite, verbatim, keyval, textcomp, enumerate, calc, microtype, hyperref}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{fig/total_savings_bar_bw.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{fig/savings_analysis_bw.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\linewidth]{savings_by_size_total_baseline.png}
...
\begin{table}[h!]
  ...
  \begin{tabular}{|l|l|}
    ...
    Brunch for Lunch (Cheesy Scrambled Eggs, Potato Wedges, & Lunch \\
    \hspace{3mm} French Toast Sticks, Turkey Sausage) & \\
    Veggie Chili & Lunch \\
    Patty Melt & Lunch \\
    Buffalo Chicken Dip & Lunch \\
    Teriyaki Chicken or Chickenless Bites Stir-Fry & Lunch \\
    \hspace{3mm} with Fried Rice and Asian Stir-Fry Vegetables & \\
    \hline
  \end{tabular}
\end{table}
