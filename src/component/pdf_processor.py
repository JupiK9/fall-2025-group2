import os
from component.utils import process_sales_data_from_pdf_text
import pandas as pd
from tqdm import tqdm
from PyPDF2 import PdfReader
import pdfplumber

def process_all_pdfs(pdf_folder, output_file):
    """
    Processes all PDF files in a folder, extracts sales data,
    and saves the combined data to a single CSV file.

    Parameters:
    - pdf_folder (str): The path to the folder containing PDF sales reports.
    - output_file (str): The path where the final combined CSV should be saved.
    """
